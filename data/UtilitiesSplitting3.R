...
write.table(cbind(street.food$BusinessName, street.food$ï..X, street.food$Y, 
                  paste(street.food$WeekdaysHours, street.food$WeekendHours, street.food$PublicHolHours, collapse = "<br/>"),street.food$Website),
...
visit = data.frame('Visitor\'s Centre',130.982218, -12.512838, 'http://www.tourismtopend.com.au/')
